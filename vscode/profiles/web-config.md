# Profile for web development with python

For Flask and django

```json
{
  "editor.fontFamily": "'JetBrainsMono Nerd Font', 'FantasqueSansM Nerd Font','FiraCode Nerd Font', 'CaskaydiaCove Nerd Font', 'CodeNewRoman Nerd Font', 'SpaceMono Nerd Font', Consolas, 'Courier New', monospace ",
  "editor.fontSize": 12,
